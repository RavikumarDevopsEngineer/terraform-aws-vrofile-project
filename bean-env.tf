resource "aws_elastic_beanstalk_environment" "vprofile-bean-prod" {
  ...
  cname_prefix        = "vpofile-bean-prod-ravikumar2580"

  setting {
    namespace = "aws:autoscaling:launchconfiguration"
    name      = "IamInstanceProfile"
    value     = "vprofile-rearch-beanrole" # EC2 instance profile
  }

  setting {
    namespace = "aws:elasticbeanstalk:environment"
    name      = "ServiceRole"
    value     = "aws-elasticbeanstalk-service-role" # Beanstalk service role
  }
